...
public class AuthAppCaptureHigh extends TestBase{
	LoginPage login;
	String transtype = "AUTH";
	//999031662056
	//String givenid = "999031661920";
	String sheetName = "CapHigh";
	String cardn = "373953192351004";
		      ...
		      if (celtext.equals("Auth")) {
		    	  ...
		    	  if(transid.equals(givenid)){
		    		  ...
		    		  for (int op=0;op<options_count;op++){
		    			  ...
		    			  if(options.get(op).getText().equalsIgnoreCase("capture")){
		    				  ...
		    				  amount.clear();
		    				  int amnt1=Integer.parseInt(amnt)+1;
		    				  amount.sendKeys(Integer.toString(amnt1));
		    				  captureScreenshot(sheetName);
