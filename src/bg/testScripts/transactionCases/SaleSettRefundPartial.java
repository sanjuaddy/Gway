...
public class SaleSettRefundPartial extends TestBase{
	LoginPage login;
	String transtype = "SALE";
	//999031662056
	//String givenid = "999031662307";
	String sheetName = "RefundPart";
	String cardn = "5500000000000004";
		    	  ...
		    	  if(transid.equals(givenid) && setstatus.contains("Settled")){
		    		  ...
		    		  for (int op=0;op<options_count;op++){
		    			  ...
		    			  if(options.get(op).getText().equalsIgnoreCase("refund")){
		    				  ...
		    				  driverwait();
		    				  captureScreenshot(sheetName);
		    				  System.out.println(driver.findElement(By.xpath("//ul[2]/li/strong")) +": "+driver.findElement(By.xpath("//ul[2]/li/span")).getText());
		    				  WebElement amount =getLocator(Repository.getProperty("bg.processing.virtualt.amnt"));
		    				  amount.clear();
		    				  int amnt1=(Integer.parseInt(amnt))/2;
