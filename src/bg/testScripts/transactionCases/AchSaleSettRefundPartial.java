...
public class AchSaleSettRefundPartial extends TestBase{
	LoginPage login;
	String TransactionType = "SALE";
	//999031662056
	//String givenid = "999031662307";
	String sheetName = "AchRefundPart";
	String Name = "Sanjay";
	...
	@BeforeMethod
	  ...
	  @Test
	  public void achSetRefParTrans() throws Exception {
		    	  ...
		    	  if(transid.equals(givenid) && setstatus.contains("Settled")){
		    		  ...
		    		  for (int op=0;op<options_count;op++){
		    			  ...
		    			  if(options.get(op).getText().equalsIgnoreCase("refund")){
		    				  ...
		    				  amount.clear();
		    				  int amnt1=(Integer.parseInt(Amount))/2;
